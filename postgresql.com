...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2022-02-10T10:44:45.836639" />
  ...
  <link href="/media/css/fontawesome.css?3926fb09" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?3926fb09">
      ...
      <div class="text">
        <ul>
            ...
            <li class=" non-badged">
              ...
              2022-02-28 &ndash; 2022-03-01 &middot; <a href="/about/event/pgconfrussia-2022-2423/">PgConf.Russia 2022</a>
            </li>
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/postgresql-jdbc-423242225-security-update-2401/">PostgreSQL JDBC 42.3.2/42.2.25 Security update</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-02-02 by JDBC Project</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/german-postgresql-conference-2022-call-for-papers-2399/">German PostgreSQL Conference 2022 &amp; Call for Papers</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-02-01 by PostgreSQL Europe</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/announcing-the-release-of-apache-ageincubating-060-2393/">Announcing the release of Apache AGE(incubating) 0.6.0</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-01-26 by Apache AGE</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/announcing-the-release-of-agensgraph-25-2338/">Announcing the release of AgensGraph 2.5</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-01-26 by Bitnine Global</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgbadger-v117-released-2398/">pgBadger v11.7 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-01-23 by MigOps</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5fL"> Most recent record (of many items) with YugabyteDB 🚀</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Franck Pachot</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-02-09</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5fK"> Postgres Constraints for Newbies</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5fI"> Install Postgres v14 + -contrib on AWS Linux 2</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5fw"> REST Data Service on YugabyteDB / PostgreSQL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Franck Pachot</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-02-07</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5fv"> Mirage of memory, part 2: PSS</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5fu"> Slow things down to make them go faster [FOSDEM 2022]</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5fx"> Bernd Helmle</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5ft"> Retry logic for optimistic locking and transparent failover 🐘🚀</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Franck Pachot</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-02-07</li>
            </ul>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5fs"> Waiting for PostgreSQL 15 – Allow archiving via loadable modules.</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hubert &#x27;depesz&#x27; Lubaczewski</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-02-06</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?3926fb09"></script>
